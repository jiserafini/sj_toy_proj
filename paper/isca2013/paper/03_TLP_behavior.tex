\section{TLP Behavior of Mobile Applications}
...
In the next five applications, responsive phases dominate application execution. 
In those applications, interactive phases do not appear, since the most of CPU usage is initiated by user inputs.
